...
For a deeper dive with examples, see the article [“ROW_NUMBER vs RANK vs DENSE_RANK: The Difference in One Example”](https://sql-academy.org/en/blog/row-number-rank-dense-rank).
